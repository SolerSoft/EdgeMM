...
namespace ModMan.Maui
{
    ...
    public static class Router
    {
        ...
        /// The detail route.
        /// </returns>
        public static string GetDetailRoute<TEntity>() where TEntity : Entity
        {
        ...
        /// The list route.
        /// </returns>
        public static string GetListRoute<TEntity>() where TEntity : Entity
        {
        ...
        /// </typeparam>
        public static void RegisterDetail<TEntity, TPage>() where TEntity : Entity where TPage : ViewPage
        {
        ...
        /// </typeparam>
        public static void RegisterList<TEntity, TPage>() where TEntity : Entity where TPage : ViewPage
        {
