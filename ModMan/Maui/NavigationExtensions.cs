...
static public class NavigationExtensions
{
    ...
    /// The navigation <see cref="Task"/>.
    /// </returns>
    static public Task GoToDetailAsync<TEntity>(this Shell shell, FormattableString param) where TEntity : Entity
    {
    ...
    /// The navigation <see cref="Task"/>.
    /// </returns>
    static public Task GoToDetailAsync<TEntity>(this Shell shell, TEntity entity) where TEntity : Entity
    {
    ...
    /// The navigation <see cref="Task"/>.
    /// </returns>
    static public Task GoToListAsync<TEntity>(this Shell shell, FormattableString param) where TEntity : Entity
    {
    ...
    /// The navigation <see cref="Task"/>.
    /// </returns>
    static public Task GoToListAsync<TEntity>(this Shell shell, IEnumerable<TEntity> entities) where TEntity : Entity
    {
